...
class MemoryClassificationSchema(BaseModel):
    ...
    category: Literal["personal", "preference", "project", "project_milestone", "ephemeral"] = (
        Field(
    ...
    should_store: bool = Field(description="Whether this fact should be stored in long-term memory")
